...
<!-- Mirrored from uideck.com/demos/estatex/submission.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 08 Jun 2019 08:32:43 GMT -->
<head>
<meta charset="UTF-8">
<meta http-equiv="X-UA-Compatible" content="IE=edge">
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta name="author" content="EstateX">
<title>Submission Form – Real Estate Theme Bootstrap HTML5 Template</title>
...
<h2 class="page-title">Submission Form</h2>
...
<input name="Adtitle" placeholder="Item" class="form-control input-md" required="" type="text">
<span class="help-block">A great item needs at least 60 characters. </span>
</div>
<div class="form-group">
<label class="control-label" for="textarea">Item description</label>
<textarea class="form-control" id="textarea" name="textarea">description what makes your ad unique</textarea>
</div>
<div class="form-group">
...
<input type="text" id="price" class="form-control" placeholder="placeholder">
...
<div class="form-group">
<select class="dropdown-product selectpicker">
<option value="0">Select alternative pricing</option>
...
<input type="text" class="form-control">
<div class="checkbox">
<label><input type="checkbox"> <small>Hide the phone number on this ads.</small></label>
</div>
</div>
<div class="form-group">
...
<h4>
<a href="index-2.html"><img src="<?php echo base_url("assets/img/logo.png");?>" class="img-responsive" alt="Footer Logo" /></a>
</h4>
<p>
...
<a href="#"><img src="assets/img/flicker/img1.png" alt=""></a>
<a href="#"><img src="assets/img/flicker/img2.png" alt=""></a>
<a href="#"><img src="assets/img/flicker/img3.png" alt=""></a>
<a href="#"><img src="assets/img/flicker/img4.png" alt=""></a>
<a href="#"><img src="assets/img/flicker/img5.png" alt=""></a>
<a href="#"><img src="assets/img/flicker/img6.png" alt=""></a>
</div>
</div>
</div>
